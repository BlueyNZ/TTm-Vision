...
export default function HazardIdNzgttmCreatePage() {
  ...
  async function onSubmit(data: z.infer<typeof hazardIdNzgttmSchema>) {
    ...
    try {
        ...
        router.push(`/jobs/${jobId}/paperwork/hazard-id-nzgttm`);
    } catch (error) {
      ...
      <Form {...form}>
        <form onSubmit={form.handleSubmit(onSubmit)}>
          ...
          <CardFooter className="justify-end gap-2">
            <Button type="button" variant="ghost" onClick={() => router.push(`/jobs/${jobId}/paperwork/hazard-id-nzgttm`)}>Cancel</Button>
