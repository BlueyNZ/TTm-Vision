                    ...
                    <CardContent className="space-y-4">
                        {emailSent ? (
                            <Alert className="border-green-200 bg-green-50">
                                ...
                                <AlertDescription className="space-y-3 mt-2 text-green-800">
                                    <p>A password reset email has been automatically sent to <strong>{createdEmail}</strong>.</p>
                                    <p className="text-sm">
                                        They should receive the email within a few minutes. The link in the email will expire in 24 hours.
                                    </p>
                                    <p className="text-sm text-muted-foreground">
                                        If they don't receive it, you can copy the link below and send it manually.
                                    </p>
                            ...
                            <Alert>
                                ...
                                <AlertDescription className="space-y-3 mt-2">
                                    <p className="text-sm text-amber-600 font-medium">
                                        ⚠️ Email service not configured. Please manually send this link.
                                    </p>
                                    ...
                                    <p className="text-xs text-muted-foreground mt-2">
                                        To enable automatic emails, see <code className="bg-muted px-1 py-0.5 rounded">EMAIL_SETUP.md</code>
                                    </p>
                                </AlertDescription>
                            </Alert>
                        )}
